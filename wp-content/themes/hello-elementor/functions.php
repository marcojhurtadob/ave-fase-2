...
add_action('admin_init','remove_plugin_updates');
...
add_action('admin_head', 'ocultar_notificaciones_plugins');
function ocultar_notificaciones_plugins() {
  echo '<style>.wpnotice-wrapper.notice { display: none !important; }</style>';
}
