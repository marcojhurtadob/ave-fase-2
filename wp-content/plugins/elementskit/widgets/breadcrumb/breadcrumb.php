...
class ElementsKit_Widget_Breadcrumb extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-breadcrumb > li.ekit_breadcrumbs_start a' => 'padding: {{TOP}}{{UNIT}} 0{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'alpha'     => false,
				'selectors' => [
					'{{WRAPPER}} .ekit-breadcrumb > li span' => 'color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'alpha'     => false,
				'selectors' => [
					'{{WRAPPER}} .ekit-breadcrumb > li:hover span' => 'color: {{VALUE}}',
		...
		$this->add_control(
			'ekit_breadcrumb_border_options_icon',
			[
				'label' => esc_html__('Icon Border Options', 'elementskit'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	private function get_crumb($settings, $post_id, $max_len, $trail = false) {
		...
		if($settings['ekit_bresdcroum_separate_icon_show'] === 'yes') {
			$separate_icon = $settings['ekit_bresdcroum_separate_icon']['value'] ?? '';
			$separate_icon_tag = '<span class="'. $separate_icon .'" aria-hidden="true"></span>';
		...
		$icon =  $settings['ekit_bresdcroum_home_icon']['value'] ?? '';
		$icon_tag = empty($settings['ekit_bresdcroum_home_icon']['value'] === '' ) ? '<span class="ekit_home_icon '. $icon .'" aria-hidden="true"></span>' : '';
